...
namespace NAMobile.DAL
{
    ...
    {
        #region  second develope by dagger.li
        //dagger do:
        ...
        public SqlHelper()
        {
           // _connectionString = CustomerWeb.Entity.Config.SqlConnectionString;
            if(sqlconnectionstring==null){
                   sqlconnectionstring = NMSoft.SecurityUtl.RSAHelper.DecryptString(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["NMAUSqlServer"].ConnectionString);
        ...
        #endregion    second develope by dagger.li
        ...
        /// <returns>An int representing the number of rows affected by the command</returns>
        private  int ExecuteNonQuery(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
        ...
        public DataSet ExecuteDataset(CommandType commandType, string commandText,params SqlParameter[] paras)
        {
            // Pass through the call providing null for the set of SqlParameters
            return ExecuteDataset(ConnectionString, commandType, commandText, paras);
        }
        ...
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        /// <returns>A dataset containing the resultset generated by the command</returns>
        private  DataSet ExecuteDataset(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
        ...
        private  DataSet ExecuteDataset(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter(cmd))
            {
                ...
                //logger.Info(da.SelectCommand.CommandText );
                da.Fill(ds);
        ...
        public DataSet ExecuteDatasetEx(string connectionString, CommandType commandType, string commandText, params object[] parameterValues)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                if (commandType == CommandType.StoredProcedure)
                {
                    ...
                    {
                        // Pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                        SqlParameter[] commandParameters = SqlHelperParameterCache.GetSpParameterSet(connection, commandText);
                    ...
                    {
                        // Otherwise we can just call the SP without params
                        return ExecuteDataset(connection, CommandType.StoredProcedure, commandText);
                    }
                }
                else
                {
        ...
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        /// <returns>A SqlDataReader containing the resultset generated by the command</returns>
        private  SqlDataReader ExecuteReader(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
        ...
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        /// <returns>A SqlDataReader containing the resultset generated by the command</returns>
        private  SqlDataReader ExecuteReader(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        /// <returns>A SqlDataReader containing the resultset generated by the command</returns>
        private  SqlDataReader ExecuteReader(SqlTransaction transaction, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");

            // Pass through to private overload, indicating that the connection is owned by the caller
            return ExecuteReader(transaction.Connection, transaction, commandType, commandText, commandParameters, SqlConnectionOwnership.Internal);
        }
        ...
        public  T ExecuteScalar<T>(string ProcedureName, params object[] commandParameters)
        {
            ...
            {
                // Pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                SqlParameter[] parameterValues = SqlHelperParameterCache.GetSpParameterSet(ConnectionString, ProcedureName);

                // Assign the provided values to these parameters based on parameter order
                AssignParameterValues(parameterValues, commandParameters);

                // Call the overload that takes an array of SqlParameters
                return (T)ExecuteScalar(ConnectionString, CommandType.StoredProcedure, ProcedureName, parameterValues);
            }
            else
            {
                // Otherwise we can just call the SP without params
                return (T)ExecuteScalar(ConnectionString, CommandType.StoredProcedure, ProcedureName);
            }
        }

        public  T ExecuteScalar<T>(CommandType commandType, string commandText)
        {
            object retObject = ExecuteScalar(ConnectionString, commandType, commandText, (SqlParameter[])null); ;

            if (retObject != null)
            {
                T retValue = (T)retObject;
                return retValue;
            }
            return default(T);
        }
        ...
        {
            // Pass through the call providing null for the set of SqlParameters
            return (T)ExecuteScalar(transaction, commandType, commandText, (SqlParameter[])null);
        }

        private  T ExecuteScalar<T>(SqlTransaction transaction, string spName, params object[] parameterValues)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                // Call the overload that takes an array of SqlParameters
                return (T)ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                // Otherwise we can just call the SP without params
                return (T)ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
            }
        }
        /// <summary>
        ...
        private  object ExecuteScalar(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            // Create & open a SqlConnection, and dispose of it after we are done
            using (SqlConnection connection = new SqlConnection(connectionString))
        ...
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        /// <returns>An object containing the value in the 1x1 resultset generated by the command</returns>
        private  object ExecuteScalar(SqlTransaction transaction, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
    ...
    public sealed   class  SqlHelperParameterCache
    {
        ...
        private static SqlParameter[] DiscoverSpParameterSet(SqlConnection connection, string spName, bool includeReturnValueParameter)
        {
            ...
            connection.Open();
            SqlCommandBuilder.DeriveParameters(cmd);//填入 (Populate) 指定 SqlCommand 物件的 Parameters 集合。
