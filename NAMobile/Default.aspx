...
I agree to the Norman Australia Pty Ltd Terms of Trade and Privacy Policy. </div>
    ...
    <div class="form-floating">
        ...
        <asp:TextBox ID="floatingInput" runat="server" CssClass="form-control" placeholder="User ID" Text="mis"  required></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        (function () {
            'use strict'
            document.getElementById("floatingPassword").value = "zhaofeng";
